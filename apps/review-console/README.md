...
- Shareable view now also states the recommended reopen path in both the card and copied note, so async reviewers know whether to start with the current selection or jump straight to the next pending event
