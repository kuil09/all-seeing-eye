...
- Shareable view now also surfaces supporting source proof snapshots in the handoff card and copied note, so async reviewers can read source titles, timing, and excerpt previews before opening provenance detail
