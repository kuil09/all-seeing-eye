...
- Shareable view now also copies a paste-ready handoff note that bundles the current link, a portable link when needed, and the included versus local-only scope cues for async review updates
