...
- Shareable view now also surfaces a reviewer snapshot plus recent persisted review context for the selected event, while trimming redundant `pending review` status when queue context already states that the current selection is still actionable
