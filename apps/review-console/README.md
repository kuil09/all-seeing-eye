...
- Shareable view now keeps the recommended reopen path in copied notes and on live cards that do not expose a direct next-pending button, so context-only live handoffs can show the next-pending headline without repeating the same follow-up guidance twice
