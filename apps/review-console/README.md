...
- Copy handoff note now emits action-first markdown sections with labeled current, portable, and next-pending links before the denser reviewer context and scope metadata, so pasted async handoffs stay scannable even when proof-rich detail is preserved
